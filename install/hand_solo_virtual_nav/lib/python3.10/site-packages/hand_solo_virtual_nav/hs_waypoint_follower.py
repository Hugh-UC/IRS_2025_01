...
def main():
    ...
    wp1 = make_pose(0.0, 0.0, 0.0)
    wp2 = make_pose(5.81, 14.0, 0.0)
    wp3 = make_pose(24.0, 13.0, 4.712)
    wp4 = make_pose(28.5, 4.33, 4.0)
    wp5 = make_pose(28.3, -3.27, 0.0)
    wp6 = make_pose(6.23, 0.035, 3.14)
