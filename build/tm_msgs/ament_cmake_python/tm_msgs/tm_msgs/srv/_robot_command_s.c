...
bool tm_msgs__srv__robot_command__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tm_msgs.srv._robot_command.RobotCommand_Request", full_classname_dest, 47) == 0);
  }
  tm_msgs__srv__RobotCommand_Request * ros_message = _ros_message;
  {  // command
...
PyObject * tm_msgs__srv__robot_command__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tm_msgs.srv._robot_command");
...
ROSIDL_GENERATOR_C_EXPORT
bool tm_msgs__srv__robot_command__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tm_msgs.srv._robot_command.RobotCommand_Response", full_classname_dest, 48) == 0);
  }
  tm_msgs__srv__RobotCommand_Response * ros_message = _ros_message;
  {  // is_success
