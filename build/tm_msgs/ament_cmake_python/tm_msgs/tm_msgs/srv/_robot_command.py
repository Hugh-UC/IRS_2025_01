...
class Metaclass_RobotCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tm_msgs.srv import _robot_command
...
class RobotCommand(metaclass=Metaclass_RobotCommand):
    from tm_msgs.srv._robot_command import RobotCommand_Request as Request
    from tm_msgs.srv._robot_command import RobotCommand_Response as Response
